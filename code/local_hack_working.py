...
def play_song(seed1, seed2, category_index):
    pygame.init()
    pygame.mixer.init()
    file = ""
    if(category_index==0):
        file = angry_file_paths[seed1]
    elif(category_index == 1):
        file = contempt_file_paths[0]
    elif(category_index == 2):
        file = disgust_file_paths[0]
    elif(category_index == 3):
        file = fear_file_paths[0]
    elif(category_index == 4 or category_index == 5):
        file = happy_file_paths[seed2]
    elif(category_index == 6):
        file = sad_file_paths[0]
    elif(category_index == 7):
        file = surprise_file_paths[0]
    else:
...
play_song(seed1 = seed1, seed2 = seed2,  category_index = highest_index)
#print(faces)